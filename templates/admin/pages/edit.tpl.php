...
<form action="" method="POST">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input name="url" id="pagesUrl" type="text" class="form-control" placeholder="URL amigavel, deixe em branco para informa a página inicial..." required value="página inicial"> 
        </div>
    </div>
